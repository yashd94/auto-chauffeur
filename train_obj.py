...
-------------------------------------------------------------------
This script trains a ResNet-based GAN to generate object masks,
i.e. binary images that correpond to top-down views of the road
with rectangular boxes depicting boxes.
"""
...
from models import ObjGenerator, Discriminator
from helper import GANLoss
from utils import save_checkpoint, print_train_stats, init_weights
...
generator = ObjGenerator(in_ch, out_ch, ngf, n_blocks=n_blocks_g, init_gain=0.02).to(device)
