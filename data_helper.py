...
class LabeledDataset_task2(torch.utils.data.Dataset):    
    def __init__(self, image_folder, annotation_file, scene_index, 
                 img_transform, map_transform, extra_info=True):
        """
        Args:
            image_folder (string): the location of the image folder
            annotation_file (string): the location of the annotations
