# Implementation modified from source by Team Crazy Glitch Asians, NYU Deep Learning Spring 2020, to train on custom dataset with the monocular un-pretrained option.
